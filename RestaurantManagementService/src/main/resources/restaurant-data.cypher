...
CREATE (gondola_m2_cat1:Category {id: randomUUID(), name: 'Pizze'})
CREATE (gondola_m2_cat2:Category {id: randomUUID(), name: 'Paste'})
CREATE (gondola_m2_cat3:Category {id: randomUUID(), name: 'Deserti'})
CREATE (gondola_m2_cat4:Category {id: randomUUID(), name: 'Salate'})
...
CREATE (gondola_mU_cat1:Category {id: randomUUID(), name: 'Uskrsnja Jela'})
CREATE (gondola_mU_cat2:Category {id: randomUUID(), name: 'Uskrsnji Deserti'})
...
CREATE (kfc_m2_cat1:Category {id: randomUUID(), name: 'Kofice'})
CREATE (kfc_m2_cat2:Category {id: randomUUID(), name: 'Burgeri'})
CREATE (kfc_m2_cat3:Category {id: randomUUID(), name: 'Wrapperi'})
...
CREATE (kfc_m3_cat1:Category {id: randomUUID(), name: 'Kofice'})
CREATE (kfc_m3_cat2:Category {id: randomUUID(), name: 'Burgeri'})
CREATE (kfc_m3_cat3:Category {id: randomUUID(), name: 'Wrapperi'})
CREATE (kfc_m3_cat4:Category {id: randomUUID(), name: 'Dodaci'})
...
CREATE (kfc_m5_cat1:Category {id: randomUUID(), name: 'Egg'})
...
CREATE (loft_cat1:Category {id: randomUUID(), name: 'Kafa i Piće'})
CREATE (loft_cat2:Category {id: randomUUID(), name: 'Sendviči'})
...
CREATE (lanterna_cat1:Category {id: randomUUID(), name: 'Specijaliteti kuće'})

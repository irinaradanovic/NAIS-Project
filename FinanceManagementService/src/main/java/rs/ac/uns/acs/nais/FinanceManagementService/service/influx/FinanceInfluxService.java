...
public class FinanceInfluxService implements CommandLineRunner {
    ...
    // CRUD API
    public void savePlacanje(PlacanjeDogadjaj dogadjaj) { placanjeRepo.save(dogadjaj); }
    ...
    public boolean deletePlacanjaByStanarId(String id) { return placanjeRepo.deleteByStanarId(id); }

    public void saveFondTransakcija(FondTransakcija t) { fondRepo.save(t); }
    ...
    public boolean deleteFondTransakcijeByFondId(String id) { return fondRepo.deleteByFondId(id); }

    // Slozeni upiti
    public List<Map<String, Object>> ukupnoPoTipuRacuna(int dani) { return placanjeRepo.ukupnoPoTipuRacuna(dani); }
    public List<Map<String, Object>> prosecnoKasnjenjePoPlacanjeStanara() { return placanjeRepo.prosecnoKasnjenjePoPlacanjeStanara(); }
    public List<Map<String, Object>> mesecniPrihodiNaVreme() { return placanjeRepo.mesecniPrihodiNaVreme(); }
    public List<Map<String, Object>> bilansPOFondu() { return fondRepo.bilansPOFondu(); }
    public List<Map<String, Object>> mesecniObrtFondova() { return fondRepo.mesecniObrtFondova(); }
    public List<Map<String, Object>> fondoviSaVisokimIsplatama(double prag) { return fondRepo.fondoviSaVisokimIsplatama(prag); }
}
...
public class Vlasnik {
    ...
    @Relationship(value = "POSEDUJE", direction = Relationship.Direction.OUTGOING)
    ...
    public List<Stan> getStanovi() { return stanovi; }
    public void setStanovi(List<Stan> stanovi) { this.stanovi = stanovi; }

    public void addStan(Stan stan) { this.stanovi.add(stan); }
}
